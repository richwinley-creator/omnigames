(function() {
  ...
  style.textContent = `
    #omni-chat-btn {
      ...
      border: none; cursor: pointer; box-shadow: 0 4px 20px rgba(184,148,61,0.4);
      display: flex; align-items: center; justify-content: center;
      transition: transform 0.2s, box-shadow 0.2s;
    }
    #omni-chat-btn:hover { transform: scale(1.08); box-shadow: 0 6px 28px rgba(184,148,61,0.5); }
    #omni-chat-btn svg { width: 28px; height: 28px; fill: #0a0a0a; }
    ...
    #omni-chat-window {
      ...
      background: #0f0f0f; border: 1px solid #2a2520;
    ...
    #omni-chat-header {
      padding: 16px 20px; background: linear-gradient(135deg, #1a1610, #0f0d08);
      border-bottom: 1px solid #2a2520; display: flex; align-items: center; gap: 12px;
    }
    ...
    #omni-chat-header .info h4 { margin: 0; font-size: 14px; color: #f5f0e8; font-weight: 600; }
    #omni-chat-header .info p { margin: 0; font-size: 11px; color: #8a8278; }
    ...
    #omni-chat-messages::-webkit-scrollbar-thumb { background: #2a2520; border-radius: 2px; }

    .omni-msg { max-width: 85%; padding: 10px 14px; border-radius: 12px; font-size: 13px; line-height: 1.5; word-wrap: break-word; }
    .omni-msg.bot { background: #1a1a1a; color: #e0d8cc; align-self: flex-start; border-bottom-left-radius: 4px; }
    .omni-msg.user { background: linear-gradient(135deg, #c9a84c, #b8943d); color: #0a0a0a; align-self: flex-end; border-bottom-right-radius: 4px; font-weight: 500; }
    ...
    #omni-chat-input-area {
      padding: 12px 16px; border-top: 1px solid #2a2520; display: flex; gap: 8px;
      background: #0a0a0a;
    }
    #omni-chat-input {
      flex: 1; padding: 10px 14px; background: #1a1a1a; border: 1px solid #2a2520;
      border-radius: 8px; color: #f5f0e8; font-size: 13px; font-family: inherit;
      outline: none; resize: none;
    }
    #omni-chat-input:focus { border-color: #c9a84c; }
    #omni-chat-input::placeholder { color: #6b6355; }
    #omni-chat-send {
    ...
    #omni-chat-send svg { width: 16px; height: 16px; fill: #0a0a0a; }
